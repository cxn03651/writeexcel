...
require 'test_50_name_stored.rb'
require 'test_51_name_print_area.rb'
require 'test_52_name_print_titles.rb'
require 'test_53_autofilter.rb'
require 'test_60_chart_generic.rb'
